...
import { TemplatedItemsComponent } from "@nativescript/angular";
import { GridView } from "../grid-view";
export declare class GridViewComponent extends TemplatedItemsComponent {
    get nativeElement(): GridView;
